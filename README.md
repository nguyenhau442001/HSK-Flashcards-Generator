...
A standalone, offline flashcard app for the 600 HSK4 vocabulary words — no install, no server, just open the HTML file in your browser.
...
- **600 HSK4 words** (HSK 2.0 standard) with pinyin + Vietnamese definitions
